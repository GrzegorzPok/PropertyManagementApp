...
namespace PropertyManagement.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IPropertyManagementRepository repo, IMapper mapper, IOptions<CloudinarySettings> cloudinaryConfig)
        {
        ...
        public async Task<IActionResult> SetMainPhoto(int propertyId, int id)
        {
            ...
            if (!property.Photos.Any(p => p.Id == id))
                return Unauthorized();
